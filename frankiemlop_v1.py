# -*- coding: utf-8 -*-
"""FrankieMLOP_V1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1itULwezfrbA9KXuls6w0Peq9Sx5nJcXO
...
class GLUETransformer(L.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # optimizer = SGD(optimizer_grouped_parameters, lr=self.hparams.learning_rate, momentum=0.9)
        # optimizer = RMSprop(optimizer_grouped_parameters, lr=self.hparams.learning_rate, alpha=0.99)
        # optimizer = Adagrad(optimizer_grouped_parameters, lr=self.hparams.learning_rate)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="models", help="Saves model checkpoints")
